...
import { Card, FormList, Header } from '../components';
  ...
  const handleClearList = () => {
    toast((t) => (
      <div className='flex flex-col gap-3'>
        <p className='block text-center text-black font-raleway sm:text-start'>
  ...
  return (
    <>
      ...
      <main className='max-width'>
        <section className='border-y-black border-y max-width'>
          <FormList
